...
public class LineOnePicker extends LinearLayout {

    /**
     * The number of items show in the selector wheel.
     */
    /* package */ static final int SELECTOR_WHEEL_ITEM_COUNT = 7;
    ...
    /**
     * The duration of the last down event.
     */
    ...
    /**
     * InterfaceWrite to listen for changes of the current value.
     */
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(LineOnePicker picker, int oldVal, int newVal);
    }

    private static final int[] PRESSED_STATE_SET = new int[] {android.R.attr.state_pressed};

    /**
     * InterfaceWrite to listen for the picker scroll state.
     */
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(LineOnePicker view, int scrollState);
    }

    /**
     * InterfaceWrite used to format current value into a string for presentation.
     */
    ...
    private int TEXT_SIZE_MAX = 33;

    private int TEXT_SIZE_MIN = 28;

    private int TEXT_SIZE_LABEL = 13;
     ...
     */
    public LineOnePicker(Context context) {
        this(context, null);
    }
     ...
     */
    public LineOnePicker(Context context, AttributeSet attrs) {
     ...
     */
    public LineOnePicker(final  Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
     ...
     * <p>
     * If the argument is less than the {@link LineOnePicker#getMinValue()} and
     * {@link LineOnePicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link LineOnePicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link LineOnePicker#getMinValue()} and
     * {@link LineOnePicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link LineOnePicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link LineOnePicker#getMaxValue()} and
     * {@link LineOnePicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link LineOnePicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link LineOnePicker#getMinValue()} and
     * {@link LineOnePicker#getMaxValue()} values.
     * <p>
...
//            y = centerY + (TEXT_SIZE_MAX - TEXT_SIZE_MIN) / 2 + TEXT_MAX_ASCENT + TEXT_SIZE_LABEL;
            mLabelPaint.setTextSize(11*getResources().getDisplayMetrics().density);
            canvas.drawText(mLabel.toString(), x + mDisplayedMaxTextWidth/2+10, centerY - TEXT_SIZE_MAX/2 + mLabelPaint.getTextSize()/2, mLabelPaint);
        }
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(LineOnePicker.class.getName());
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            LineOnePicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            LineOnePicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                LineOnePicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (LineOnePicker.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (LineOnePicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (LineOnePicker.this.isEnabled()) {
                                LineOnePicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (LineOnePicker.this.isEnabled()) {
                                ...
                                LineOnePicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            ...
            if (acm.isEnabled()) {
                ...
                event.setSource(LineOnePicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(LineOnePicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType, String text) {
            ...
            if (acm.isEnabled()) {
                ...
                event.setEnabled(LineOnePicker.this.isEnabled());
                event.setSource(LineOnePicker.this, virtualViewId);
                requestSendAccessibilityEvent(LineOnePicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText(
            ...
            info.setSource(LineOnePicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(LineOnePicker.this, virtualViewId);
            info.setParent(LineOnePicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(LineOnePicker.this.isEnabled());
            Rect boundsInParent = mTempRect;
            boundsInParent.set(left, top, right, bottom);
            info.setVisibleToUser(getVisibility() == View.VISIBLE);
            info.setBoundsInParent(boundsInParent);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(LineOnePicker.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(LineOnePicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(LineOnePicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(LineOnePicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(LineOnePicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
