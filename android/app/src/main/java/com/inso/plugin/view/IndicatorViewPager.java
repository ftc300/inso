...
public class IndicatorViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private List<Integer> infos;//数据集合
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.watch_indicator_view, this, true);
    ...
    public void setData(List<Integer> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<Integer> list, ImageCycleViewListener listener, int showPosition) {
...
//        setWheel(true);//设置轮播
     ...
     * @param drawableId
     */
    private View getImageView(Context context, int drawableId) {
...
//        }
    ...
    public static interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        public void onImageClick(Integer info, int position, View imageView);
    }
}
