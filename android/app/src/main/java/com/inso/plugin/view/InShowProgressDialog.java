...
public class InShowProgressDialog extends MLAlertDialog {
    ...
    public TextView getmProgressCancel() {
        return mProgressCancel;
    }
    ...
    public static InShowProgressDialog show(Context context, CharSequence title,
    ...
    public static InShowProgressDialog show(Context context, CharSequence title,
        ...
        InShowProgressDialog dialog = new InShowProgressDialog(context);
    ...
    public InShowProgressDialog(Context context) {
        this(context, R.style.V5_AlertDialog);
    }

    public InShowProgressDialog(Context context, int theme) {
        super(context, theme);
