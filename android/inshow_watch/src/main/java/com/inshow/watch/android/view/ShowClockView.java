...
import static com.inshow.watch.android.R.color.watch_clock_gray;

/**
 * Created by chendong on 2017/3/13.
 */
//public class ShowClockView extends View implements SensorEventListener {
public class ShowClockView extends View  {
    /* 画布 */
...
//    private int tempLRValue;
    ...
    public ShowClockView(Context context) {
        this(context, null);
    }

    public ShowClockView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShowClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        mHourHandPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mHourHandPaint.setStyle(Paint.Style.FILL);
        mHourHandPaint.setColor(getResources().getColor(watch_clock_gray));


        mMinuteHandPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mMinuteHandPaint.setColor(getResources().getColor(watch_clock_gray));


        mSecondHandPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mSecondHandPaint.setStyle(Paint.Style.STROKE);
        mSecondHandPaint.setColor(getResources().getColor(watch_clock_gray));


        mScaleLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mScaleLinePaint.setStyle(Paint.Style.STROKE);
        mScaleLinePaint.setColor(getResources().getColor(watch_clock_gray));
        mScaleLinePaint.setStrokeWidth((float) 3);
...
//        mMinuteHandPaint.setStrokeWidth(0.02f * mRadius);
    ...
    public void setSecondHandPaint(boolean isConnect){
        mSecondHandPaint.setColor(getResources().getColor(isConnect?R.color.watch_red: watch_clock_gray));
        mMinuteHandPaint.setColor(getResources().getColor(isConnect?R.color.black_90_transparent: watch_clock_gray));
        mHourHandPaint.setColor(getResources().getColor(isConnect?R.color.black_90_transparent:watch_clock_gray));
    }
