package com.inshow.watch.android.view.pieview;
            ...
            switch (event.getAction()){
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (rTra< touchRadius && touchRadius< r){
                        ...
                        if(null!=clickListener) clickListener.click(angleId);
                        invalidate();
                    }
                    return true;
        ...
        for (int i=0; i<n; i++){
            ...
            switch (attr){
                ...
                case R.styleable.PieChart_percentDecimal:
                    ...
                    break;
                case R.styleable.PieChart_pietextSize:
...
//        float textWidth =paint.measureText(string+"");
    ...
    private void drawText(Canvas canvas, PieData pie ,float currentStartAngle, NumberFormat numberFormat,boolean flag){
        ...
        mPoint.y = textPathY;
        String[] strings;
        strings = new String[]{pie.getName()};
//        if (flag){
