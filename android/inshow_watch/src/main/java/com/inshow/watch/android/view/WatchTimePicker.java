...
public class WatchTimePicker extends FrameLayout {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            public WatchTimePicker.SavedState createFromParcel(Parcel in) {
                return new WatchTimePicker.SavedState(in);
            }

            public WatchTimePicker.SavedState[] newArray(int size) {
                return new WatchTimePicker.SavedState[size];
            }
        };
    }
