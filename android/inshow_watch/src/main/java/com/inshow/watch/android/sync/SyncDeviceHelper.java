...
import static com.inshow.watch.android.manager.BleManager.I2B_Control;
...
import static com.inshow.watch.android.manager.BleManager.changeVipState;
...
//        XmBluetoothManager.getInstance().write(MAC, UUID.fromString(IN_SHOW_SERVICE), UUID.fromString(CHARACTERISTIC_VIP), setVip(item.id + 1, 2, item.number.getBytes(Charset.forName("UTF-8"))), new Response.BleWriteResponse() {
//            @Override
//            public void onResponse(int code, Void data) {
//
//            }
